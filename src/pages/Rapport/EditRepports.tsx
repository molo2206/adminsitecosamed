...
function EditRepports() {
	...
	useEffect(() => {
		setInputs({
			title:
				showingTranslateValue(reports?.translations, pageLang)?.title || '',
			description:
				showingTranslateValue(reports?.translations, pageLang)?.description ||
				'',
